                ...
                tx.executeSql(`update ${medicamentos} set  qntTotal=?
                   where compartimento = ?`,
                    ...
                    (_, { insertId, rows }) => {
                        ...
                        this.enviaDados();
                        this.props.navigation.navigate('Reposicao',  {repoeD: totaal, reposD: true, reposC: false, reposB: false, repoeA: false})
                ...
                <ScrollView>
                    <Fragment>
                        ...
                        <View style={{ marginTop: 30 }}>
                            ...
                            <Text style={{ color:'black',fontSize: 20, fontWeight: 'bold', marginLeft: 15, marginTop: 0 }}>Compartimento D:</Text>
                            <View style={{ backgroundColor: 'white', width: 390, marginLeft: 10, marginTop: 15, borderRadius: 10,borderColor:'#83B5F8', borderWidth: 0.5 }}>
                                ...
                                <View>
                                    <Text style={{ fontWeight: 'bold', marginLeft: 15, width: 200, marginTop: 10,  fontSize: 15 }}>Quantidade Reposição:</Text>
                                    <TextInput
                                        placeholder="0"
                                    ...
                                    <TextInput
                                        ...
                                        editable  = {false}
                                    />
                                    <Text style={{ fontSize:15,position: 'absolute', width: 190, marginTop: 110, marginLeft: 68 }}>Comprimido(s)</Text>
