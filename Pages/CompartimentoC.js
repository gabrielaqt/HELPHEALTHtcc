...
*/
            if (this.state.select1x == true) {
                ...
                {
                    await adicionarMed.adicionarMed(json);
                    this.props.navigation.navigate('RegisterMedicines', {checkedC: true})
                ...
                <ScrollView>
                    <Fragment>
                        ...
                        <View style={{ marginTop: 30 }}>
                            ...
                            <Text style={{ color:'black',fontSize: 20, fontWeight: 'bold', marginLeft: 15, marginTop: 0 }}>Compartimento C:</Text>
                            <View style={{ backgroundColor: 'white', width: 390, marginLeft: 10, marginTop: 15, borderRadius: 10,borderColor:'#83B5F8', borderWidth: 0.5 }}>
                                <Text style={{ color:'black',fontWeight: 'bold', marginLeft: 15, width: 200, marginTop: 5, fontSize: 15 }}>Nome Remédio:</Text>
                                ...
                                />
                                <TouchableOpacity activeOpacity={0.5} style={estilo.opacity} onPress={() => this.props.navigation.navigate('camera', {compA: false, compB: false, compC: true, compD: false, compE: false})}>
                                ...
                                <View>
                                    <Text style={{color:'black', fontWeight: 'bold', marginLeft: 15, width: 200, marginTop: 10,  fontSize: 15 }}>Total Comprimidos Caixa:</Text>
                                    <TextInput
                                        placeholder="0"
                                    ...
                                    <TextInput
                                        placeholder="0"
                                        style={{color:'black', fontSize: 15, fontSize: 15,textAlign: 'center', position: 'absolute', borderRadius: 10, paddingHorizontal: 10, width: 50, height: 40, borderColor: 'gray', backgroundColor: 'white', borderWidth: 1, marginLeft: 15, marginTop: 105 }}
