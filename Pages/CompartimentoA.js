                ...
                <ScrollView>
                    <Fragment>
                        ...
                        <View style={{ marginTop: 30 }}>
                            ...
                            <Text style={{ color:'black',fontSize: 20, fontWeight: 'bold', marginLeft: 15, marginTop: 0 }}>Compartimento A:</Text>
                            <View style={{ backgroundColor: 'white', width: 390, marginLeft: 10, marginTop: 15, borderRadius: 10,borderColor:'#83B5F8', borderWidth: 0.5 }}>
                                ...
                                />
                                <TouchableOpacity activeOpacity={0.5} style={estilo.opacity} onPress={() => this.props.navigation.navigate('camera', {compA: true, compB: false, compC: false, compD: false, compE: false})}>
                                ...
                                <View>
                                    ...
                                    <TextInput
                                        placeholder="0"
                                        style={{ fontSize: 15, fontSize: 15,textAlign: 'center', position: 'absolute', borderRadius: 10, paddingHorizontal: 10, width: 50, height: 40, borderColor: 'gray', backgroundColor: 'white', borderWidth: 1, marginLeft: 15, marginTop: 105 }}
