    ...
    salvarMedicamentos = async() => {
      console.log("jhgjhgjh")
            ...
            if (this.state.select1x == true) {
              ...
              //     adicionarMed(json);
                    this.props.navigation.navigate('RegisterMedicines', {checkedE: true})
                ...
                <ScrollView>
                    <Fragment>
                        ...
                        <View style={{ marginTop: 30 }}>
                            ...
                            <Text style={{ color:'black',fontSize: 20, fontWeight: 'bold', marginLeft: 15, marginTop: 0 }}>Compartimento E:</Text>
                            <View style={{ backgroundColor: 'white', width: 390, marginLeft: 10, marginTop: 15, borderRadius: 10,borderColor:'#83B5F8', borderWidth: 0.5 }}>
                                <Text style={{color:'black',fontSize: 15, fontWeight: 'bold', marginLeft: 15, width: 200, marginTop: 5 }}>Nome Remédio:</Text>
                                ...
                                />
                                <TouchableOpacity activeOpacity={0.5} style={estilo.opacity} onPress={() => this.props.navigation.navigate('camera', {compA: false, compB: false, compC: false, compD: false, compE: true})}>
