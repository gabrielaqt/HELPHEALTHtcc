...
export default class Home extends Component {
    ...
    ws = new WebSocket(`ws://192.168.0.254:1337/qntRemedio`)
    ...
    componentDidMount() 
    {
        ...
        this.ws.onopen = (teste) =>{
            console.log("CONECTADO");
            this.ws.send('remedio'); // send a message
            console.log(teste);
        }
        ...
        return (
            ...
            <View >
                ...
                <View style={{ marginLeft: 7, borderRadius: 10, borderColor: '#83B5F8', borderWidth: 0.5, marginTop: 20, backgroundColor: 'white', height: 590, width: 400 }}>
                    ...
                    <Text style={{ fontSize: 17, fontWeight: 'bold', marginLeft: 15, marginTop: 20,textDecorationLine:'underline' }}>Compartimento A:</Text>

                        {
                            this.state.existeA?(
                            <View>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Remédio:</Text> {this.state.nomeA}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Quantidade Disponível:</Text> {this.state.qntA}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Horários:</Text> {this.state.h1A} {this.state.h2A} {this.state.h3A} {this.state.h4A}</Text>
                               
                            </View>):(
                            <View>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}>Não Cadastrado</Text>
                            </View>)
                        }

                        <Text style={{ fontSize: 17, fontWeight: 'bold', marginLeft: 15, marginTop: 20 , textDecorationLine:'underline'}}>Compartimento B:</Text>

                        {   this.state.existeB ?(
                            <View>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Remédio:</Text> {this.state.nomeB}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Quantidade Disponível:</Text> {this.state.qntB}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Horários:</Text> {this.state.h1B} {this.state.h2B} {this.state.h3B} {this.state.h4B}</Text>
                        ...
                        <Text style={{ fontSize: 17, fontWeight: 'bold', marginLeft: 15, marginTop: 20,textDecorationLine:'underline' }}>Compartimento C:</Text>

                        { this.state.existeC ?(
                            <View> 
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Remédio:</Text> {this.state.nomeC}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Quantidade Disponível:</Text> {this.state.qntC}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Horários:</Text> {this.state.h1C} {this.state.h2C} {this.state.h3C} {this.state.h4C}</Text>
                        ...
                        <Text style={{ fontSize: 17, fontWeight: 'bold', marginLeft: 15, marginTop: 20,textDecorationLine:'underline' }}>Compartimento D:</Text>
                        {
                            this.state.existeD ?(
                            <View>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Remédio:</Text> {this.state.nomeD}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Quantidade Disponível:</Text> {this.state.qntD}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Horários:</Text> {this.state.h1D} {this.state.h2D} {this.state.h3D} {this.state.h4D}</Text>
                        ...
                        <Text style={{ fontSize: 17, fontWeight: 'bold', marginLeft: 15, marginTop: 20,textDecorationLine:'underline' }}>Compartimento E:</Text>

                        {  this.state.existeE ?(
                            <View>

                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Remédio:</Text> {this.state.nomeE}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Quantidade Disponível:</Text> {this.state.qntE}</Text>
                                <Text style={{ fontSize: 16, marginLeft: 25, marginTop: 10 }}><Text style={{ fontWeight: 'bold'}}>Horários:</Text> {this.state.h1E} {this.state.h2E} {this.state.h3E} {this.state.h4E}</Text>
